export const translations = {
  he: {
    ...
    // Hero
    hero: {
      title: "כל פתרונות הנדל״ן והפיננסים במקום אחד",
      subtitle: "ליווי משפטי, ייעוץ משכנתאות, שמאות מקרקעין וניהול נכסי נדל״ן בפריסה ארצית",
      description:
        "ברוכים הבאים ל״לוי פיננסים״ – החברה שנותנת לך שקט וביטחון בכל עסקת נדל״ן. אנו מלווים לקוחות פרטיים, עסקים, חברות ויזמים לאורך כל שלבי העסקה – מהבדיקות המקדימות, דרך המימון ועד לסיום הבירוקרטיה – תחת קורת גג אחת.",
      cta1: "לתיאום פגישה ראשונית",
      cta2: "לשירותים שלנו",
      tagline: "אמינות. מקצועיות. ליווי אישי.",
    },
    // About
    about: {
      title: "אודות בית לוי",
    ...
    services: {
      title: "השירותים שלנו",
      subtitle: "שירותים מקצועיים. תוצאה מדויקת.",
      cta: "קבל ייעוץ ראשוני",
      schedule: "לתיאום פגישה",
      mortgage: {
    ...
    contact: {
      title: "צור קשר",
      subtitle: "מעוניינים לקבל ייעוץ ראשוני? השאירו פרטים ונחזור אליכם בהקדם",
      form: {
        name: "שם מלא",
        namePlaceholder: "הכנס את שמך המלא",
        phone: "טלפון",
        phonePlaceholder: "הכנס את מספר הטלפון",
        email: "אימייל",
        emailPlaceholder: "הכנס את כתובת האימייל",
        service: "תחום עניין",
        servicePlaceholder: "בחר תחום",
